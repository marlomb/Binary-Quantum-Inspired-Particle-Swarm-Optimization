...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar 31 15:26:45 2024
...
if __name__ == '__main__':
    ...
    minFitness = min(fPB)
    thetaGB = theta[fPB.index(minFitness)]
    binGB = binary[fPB.index(minFitness)]
    print('Index of Global Best Particle: {}, Fitness: {}\n{}'.format(fPB.index(minFitness), minFitness, binGB))
        
    print('-'*80)
    
    gBestFitness = []
    gBestFitness.append(minFitness)
